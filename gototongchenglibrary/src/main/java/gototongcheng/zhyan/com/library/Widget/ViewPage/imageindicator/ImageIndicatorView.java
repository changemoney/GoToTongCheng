package gototongcheng.zhyan.com.library.Widget.ViewPage.imageindicator;
	...
	protected void refreshIndicateView() {
		...
		for (int index = 0; index < totelCount; index++) {
			...
			if (currentIndex == index) {
				...
				imageView.setBackgroundResource(R.drawable.point_skyblue);
			} else {
				imageView.setBackgroundResource(R.drawable.point_wheat);
